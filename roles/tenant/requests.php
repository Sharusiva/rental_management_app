...
// 1. Get user data and role from session
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $issue = trim($_POST['issue']); // Remove whitespace
    ...
    if (strlen($issue) > 500) { // Matches your diagram's varchar(500)
    ...
    if (empty($errors)) {
        // --- (FIXED) SQL INJECTION ---
        // Validation passed, proceed with secure prepared statement
...
<body>
    ...
    <div class="container">
        ...
        <!-- (NEW) STYLED FORM -->
        <!-- (THE FIX: Set the 'action' to the current page's full URL) -->
